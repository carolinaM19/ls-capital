...
export default function DealsPage() {
  const properties = [
    { address: '4255 Vinson Ave', city: 'Macon, GA', price: 80000, rent: 1100, mortgage: 319.47, beds: 4, baths: 1, occupied: true, section8: true },
    { address: '1514 Dexter Ave', city: 'Macon, GA', price: 67000, rent: 825, mortgage: 267.55, beds: 2, baths: 1, occupied: true, section8: true },
    { address: '129 E Virginia', city: 'Macon, GA', price: 75000, rent: 1000, mortgage: 299.50, beds: 3, baths: 2, occupied: true, section8: false },
    { address: '5161 Pinefield Dr', city: 'Macon, GA', price: 84000, rent: 1052, mortgage: 335.44, beds: 3, baths: 1, occupied: true, section8: true },
    { address: '1723 Cedar St', city: 'Macon, GA', price: 80000, rent: 1050, mortgage: 319.47, beds: 2, baths: 1, occupied: true, section8: false },
    { address: '1527 Hurley Cir', city: 'Macon, GA', price: 58500, rent: 750, mortgage: 233.61, beds: 3, baths: 1, occupied: true, section8: false },
    { address: '3771 Walker Ave', city: 'Macon, GA', price: 80000, rent: 1200, mortgage: 319.47, beds: 3, baths: 2, occupied: true, section8: false },
  ]
            ...
            {properties.map((p, i) => {
              ...
              return (
                <tr key={i} className="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors">
                  ...
                  <td className="px-4 py-3 text-slate-400">${p.mortgage.toFixed(2)}/mo</td>
                  <td className="px-4 py-3 font-medium" style={{color: cashFlow >= 0 ? '#34d399' : '#f87171'}}>${cashFlow.toFixed(0)}/mo</td>
