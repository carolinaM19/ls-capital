...
const mainNav = [
  { href: '/dashboard', label: 'Dashboard', icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 016 3.75h2.25A2.25 2.25 0 0110.5 6v2.25a2.25 2.25 0 01-2.25 2.25H6a2.25 2.25 0 01-2.25-2.25V6zM3.75 15.75A2.25 2.25 0 016 13.5h2.25a2.25 2.25 0 012.25 2.25V18a2.25 2.25 0 01-2.25 2.25H6A2.25 2.25 0 013.75 18v-2.25zM13.5 6a2.25 2.25 0 012.25-2.25H18A2.25 2.25 0 0120.25 6v2.25A2.25 2.25 0 0118 10.5h-2.25a2.25 2.25 0 01-2.25-2.25V6zM13.5 15.75a2.25 2.25 0 012.25-2.25H18a2.25 2.25 0 012.25 2.25V18A2.25 2.25 0 0118 20.25h-2.25A2.25 2.25 0 0113.5 18v-2.25z" /></svg> },
  { href: '/deals', label: 'Deal Inbox', icon: <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" /></svg> },
...
export default function Sidebar({ user }: SidebarProps) {
  ...
  return (
    <aside className="w-52 flex flex-col flex-shrink-0" style={{background: '#ffffff', borderRight: '1px solid #e2e8f0'}}>
      {/* Brand */}
      <div className="px-4 py-5" style={{borderBottom: '1px solid #f1f5f9'}}>
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="text-xs font-bold text-slate-800" style={{fontFamily: 'Sora, sans-serif'}}>LS Capital</div>
            <div className="text-[9px] text-slate-400 tracking-widest uppercase">Deal Intelligence</div>
          </div>
        </div>
      </div>
      ...
      <div className="p-3" style={{borderTop: '1px solid #f1f5f9'}}>
        <div className="flex items-center gap-2.5 px-1 mb-2">
          <div className="w-7 h-7 rounded-full flex items-center justify-center text-[11px] text-white font-bold flex-shrink-0"
        ...
        <button
          ...
          className="w-full text-left px-2 py-1.5 text-xs text-slate-400 hover:text-slate-600 transition-colors rounded-md hover:bg-slate-50"
        >
          Sign out
        </button>
      </div>
